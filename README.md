...
here is the link for the front-end PR https://github.com/bronnie313/hello-react-front-end/pull/1
...
Clone this repository to your desired folder: ` @https://github.com/bronnie313/hello-rails-backend.git `
...
Install this project with: ` hello-rails-backend  `
` bundle install `
...
To run tests, run the following command: ` rspec filename_spec.rb `
...
You can deploy this project using: `https://github.com/bronnie313/hello-rails-backend.git`
...
Feel free to check the [issues page](https://github.com/bronnie313/hello-rails-backend/issues).
...
This project is [MIT](https://github.com/bronnie313/hello-rails-backend/blob/develop/LICENSE) licensed.
